          ...
          <div className="relative z-10 hidden lg:flex lg:flex-col lg:justify-center lg:h-full lg:p-12 xl:p-16 w-full">
            ...
            <div className="space-y-8">
              <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight">
                Start Your <br/>
                <span className="bg-gradient-to-r from-blue-400 to-violet-400 bg-clip-text text-transparent">Journey Today</span>
              </h2>
              ...
              <div className="space-y-5 pt-4">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-300 font-medium">Free to get started</span>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-300 font-medium">Track your progress</span>
                </div>
              </div>
            </div>
          </div>
